...
public class Registro extends javax.swing.JFrame {
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        if (id.equals("")){
            JOptionPane.showMessageDialog(null, "Favor ingresar numero id");
        }
        ...
        String consulta = "INSERT INTO registro(id,usuario,nombre,apellido,telefono,correo,pasword) values (?,?,?,?,?,?,?);";
        ...
        try {
            ...
            pt.setString(3, nombre);
            pt.setString(4, apellido);
            pt.setString(5, telefono);
            pt.setString(6, correo);
            pt.setString(7, pasword);
